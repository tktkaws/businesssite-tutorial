                ...
                <ul class="shopList">
                    <li class="shopList-item">
                        <div class="shop-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/otemachi_cinema.png"
                                alt="" />
                        </div>
                        <div class="shop-body">
                    ...
                    <li class="shopList-item">
                        <div class="shop-image">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/otemachi_shikou.png"
                                alt="" />
                        </div>
                        <div class="shop-body">
